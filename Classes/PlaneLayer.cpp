...
bool PlaneLayer::init()
{
	...
	do 
	{
		...
		CCSprite* plane=CCSprite::createWithSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("hero1.png"));
		...
		animation->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("hero1.png"));
		animation->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("hero2.png"));
...
void PlaneLayer::Blowup(int passScore)
{
	if(isAlive)
	{
		...
		animation->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("hero_blowup_n1.png"));
		animation->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("hero_blowup_n2.png"));
		animation->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("hero_blowup_n3.png"));
		animation->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("hero_blowup_n4.png"));
