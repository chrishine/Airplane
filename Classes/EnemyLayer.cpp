...
bool EnemyLayer::init()
{
	...
	do 
	{
		...
		enemy1SpriteFrame=CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy1.png");
		enemy2SpriteFrame=CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy2.png");
		enemy3SpriteFrame_1=CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy3_n1.png");
		enemy3SpriteFrame_2=CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy3_n2.png");

		CCAnimation* animation1=CCAnimation::create();
		animation1->setDelayPerUnit(0.1f);
		animation1->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy1_down1.png"));
		animation1->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy1_down2.png"));
		animation1->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy1_down3.png"));
		animation1->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy1_down4.png"));

		CCAnimation* animation2=CCAnimation::create();
		animation2->setDelayPerUnit(0.1f);
		animation2->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy2_down1.png"));
		animation2->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy2_down2.png"));
		animation2->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy2_down3.png"));
		animation2->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy2_down4.png"));

		CCAnimation* animation3=CCAnimation::create();
		animation3->setDelayPerUnit(0.1f);
		animation3->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy3_down1.png"));
		animation3->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy3_down2.png"));
		animation3->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy3_down3.png"));
		animation3->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy3_down4.png"));
		animation3->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy3_down5.png"));
		animation3->addSpriteFrame(CCSpriteFrameCache::getInstance()->spriteFrameByName("enemy3_down6.png"));
